...
contract TeraBlock is Ownable, Signer {
    ...
    uint256 public constant TGE_Percentage = 1e19;
    uint256 public constant REMAINING_PERCENTAGE = 9e19;
    uint256 public constant PERIODS = 300;
     ...
     */
    function withdrawBEP20(address tokenAddress_, uint256 amount) external onlyOwner {
        IBEP20 tokenAddress = IBEP20(tokenAddress_);
        require(
